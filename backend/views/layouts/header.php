...
<header class="main-header">
    ...
    <?= Html::a('<span class="logo-mini">APP</span><span class="logo-lg">' . '<h2>PE&CO</h2>' . '</span>', Yii::$app->homeUrl, ['class' => 'logo']) ?>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="<?= $directoryAsset ?>/img/logo1.jpg" class="img-circle"
                                                 alt="User Image"/>
                                        </div>
                                        <h4>
                                            Support Team
               ...
               <!-- \advancedPrueba2\backend\web\assets\6ef6cd0f\img -->
